...
(function() {
  ...
  define(["jquery", "js/views/feedback", "js/views/feedback_notification", "js/views/feedback_alert", "js/views/feedback_prompt", "sinon"], function($, SystemFeedback, NotificationView, AlertView, PromptView, sinon) {
    ...
    describe("SystemFeedback", function() {
      ...
      return it("close button sends a .hide() message", function() {
        var view;
    ...
    describe("SystemFeedback click events", function() {
      beforeEach(function() {
    ...
    describe("SystemFeedback not preventing events", function() {
      beforeEach(function() {
    ...
    describe("SystemFeedback multiple secondary actions", function() {
      beforeEach(function() {
    ...
    return describe("NotificationView minShown and maxShown", function() {
      ...
      it("should not have minShown or maxShown by default", function() {
        var view;
      ...
      it("a minShown view should not hide too quickly", function() {
        var view;
        view = new NotificationView.Confirmation({
          minShown: 1000
        });
      ...
      it("a maxShown view should hide by itself", function() {
        var view;
        view = new NotificationView.Confirmation({
          maxShown: 1000
        });
      ...
      it("a minShown view can stay visible longer", function() {
        var view;
        view = new NotificationView.Confirmation({
          minShown: 1000
        });
      ...
      it("a maxShown view can hide early", function() {
        var view;
        view = new NotificationView.Confirmation({
          maxShown: 1000
        });
