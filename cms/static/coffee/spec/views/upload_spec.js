...
(function() {
  ...
  define(["js/models/uploads", "js/views/uploads", "js/models/chapter", "js/spec_helpers/create_sinon", "js/spec_helpers/modal_helpers"], function(FileUpload, UploadDialog, Chapter, create_sinon, modal_helpers) {
    var feedbackTpl;
