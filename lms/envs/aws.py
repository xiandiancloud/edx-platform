...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'xiandiancloud@163.com')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', 'cete55')  # django default is ''
