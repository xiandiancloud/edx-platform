...
(function() {
  ...
  DataDownload = (function() {
    ...
    function DataDownload($section) {
      ...
      this.$download_display_table = this.$download.find('.data-display-table');
      this.$download_request_response_error = this.$download.find('.request-response-error');
      this.$grades = this.$section.find('.grades-download-container');
      this.$grades_request_response = this.$grades.find('.request-response');
      this.$grades_request_response_error = this.$grades.find('.request-response-error');
      ...
      this.$calculate_grades_csv_btn.click(function(e) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            _this.$grades_request_response.text(data['status']);
    ...
    DataDownload.prototype.clear_display = function() {
      ...
      this.$grades_request_response.empty();
      this.$grades_request_response_error.empty();
      $(".msg-confirm").css({
        "display": "none"
      });
      return $(".msg-error").css({
