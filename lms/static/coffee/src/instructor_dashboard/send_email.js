...
(function() {
  var Email, PendingInstructorTasks, SendEmail, create_email_content_table, create_email_message_views, create_task_list_table, plantTimeout, std_ajax_err;
  ...
  SendEmail = (function() {
    ...
    function SendEmail($container) {
      ...
      this.$btn_send.click(function() {
        var confirm_message, full_confirm_message, send_data, send_to, subject, success_message;
