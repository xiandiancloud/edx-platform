  ...
  Extensions = (function() {
    ...
    function Extensions($section) {
      ...
      this.$show_unit_extensions.click(function() {
        ...
        _this.$url_input = _this.$section.find("#view-extensions select[name='url']");
        ...
        return $.ajax({
          ...
          data: send_data,
          error: function(xhr) {
            return _this.fail_with_error("view-extensions", "Error getting due dates", xhr);
          },
          success: function(data) {
      ...
      this.$show_student_extensions.click(function() {
        ...
        _this.$student_input = _this.$section.find("#view-extensions input[name='student']");
        send_data = {
          student: _this.$student_input.val()
        };
        return $.ajax({
