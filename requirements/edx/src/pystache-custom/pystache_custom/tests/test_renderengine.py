...
from pystache_custom.context import ContextStack
from pystache_custom import defaults
from pystache_custom.parser import ParsingError
from pystache_custom.renderengine import RenderEngine
from pystache_custom.tests.common import AssertStringMixin, Attachable
...
class RenderTests(unittest.TestCase, AssertStringMixin):
    ...
    def test_section__nested_truthy(self):
        ...
        Test case for issue #24: https://github.com/defunkt/pystache_custom/issues/24
    ...
    def test_section__nested_with_same_keys(self):
        ...
        Test case for issue #36: https://github.com/defunkt/pystache_custom/issues/36
    ...
    def test_custom_delimiters__sections(self):
        ...
        Test case for issue #20: https://github.com/defunkt/pystache_custom/issues/20
    ...
    def test_custom_delimiters__not_retroactive(self):
        ...
        Test case for issue #35: https://github.com/defunkt/pystache_custom/issues/35
