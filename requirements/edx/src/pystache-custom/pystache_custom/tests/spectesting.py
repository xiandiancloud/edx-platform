...
# TODO: move all of this code to pystache_custom/tests/spectesting.py and
...
from pystache_custom import common
...
def get_spec_tests(spec_test_dir):
    ...
    print "pystache_custom: spec tests: using %s" % _get_parser_info()
