...
from pystache_custom.tests.common import PACKAGE_DIR, PROJECT_DIR, SPEC_TEST_DIR, UNITTEST_FILE_PREFIX
from pystache_custom.tests.common import get_module_names
from pystache_custom.tests.doctesting import get_doctests
from pystache_custom.tests.spectesting import get_spec_tests
...
def main(sys_argv):
    ...
    print "pystache_custom: running tests: expecting source: %s" % should_source_exist
...
class SetupTests(unittest.TestCase):
    ...
    def test_version(self):
        ...
        try:
            ...
            self.assertEqual(VERSION, pystache_custom.__version__)
        finally:
