...
from pystache_custom.tests.common import EXAMPLES_DIR
from pystache_custom.tests.common import AssertStringMixin
...
class TestSimple(unittest.TestCase, AssertStringMixin):
    ...
    def test_empty_context(self):
        ...
        self.assertEqual(pystache_custom.Renderer().render(template), "Should see me")
    ...
    def test_non_existent_value_renders_blank(self):
        ...
        self.assertEqual(pystache_custom.Renderer().render(template), ' ')
